...
function controlarColumnasPorRol() {
  ...
  const rolesAutorizados = ['ADMINISTRACION', 'GERENTE', 'RESIDENTE', 'COMPRAS', 'JEFE'];
 ...
 * - RESIDENTE o COMPRAS: Puede ver y usar "Subir requerimiento".
